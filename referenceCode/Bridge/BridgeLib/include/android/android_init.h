...
BRIDGE_API int bridge_run_module(const wchar_t* moduleName, int argc, char** argv, int envc, char** envp);
BRIDGE_API int bridge_execve(const char* filename, int argc, char** argv, int envc, char** envp);
BRIDGE_API const wchar_t* bridge_get_default_app_process_module();
